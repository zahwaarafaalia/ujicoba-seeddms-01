...
class ComposerStaticInitfabec6c76cad6aaeaa67db2d20cc093d
{
    ...
    public static $classMap = array (
        ...
        'SeedDMS\\Core\\DocumentIterator' => __DIR__ . '/../..' . '/Core/inc.ClassIterator.php',
        'SeedDMS\\Core\\FolderFilterIterator' => __DIR__ . '/../..' . '/Core/inc.ClassIterator.php',
        'SeedDMS\\Core\\FolderIterator' => __DIR__ . '/../..' . '/Core/inc.ClassIterator.php',
        'SeedDMS\\Core\\RecursiveFolderFilterIterator' => __DIR__ . '/../..' . '/Core/inc.ClassIterator.php',
        'SeedDMS\\Core\\RecursiveFolderIterator' => __DIR__ . '/../..' . '/Core/inc.ClassIterator.php',
        'SeedDMS_Core_AddContentResultSet' => __DIR__ . '/../..' . '/Core/inc.ClassDocument.php',
        'SeedDMS_Core_Attribute' => __DIR__ . '/../..' . '/Core/inc.ClassAttribute.php',
        'SeedDMS_Core_AttributeDefinition' => __DIR__ . '/../..' . '/Core/inc.ClassAttribute.php',
        'SeedDMS_Core_DMS' => __DIR__ . '/../..' . '/Core/inc.ClassDMS.php',
        'SeedDMS_Core_DatabaseAccess' => __DIR__ . '/../..' . '/Core/inc.DBAccessPDO.php',
        'SeedDMS_Core_Decorator' => __DIR__ . '/../..' . '/Core/inc.ClassDecorator.php',
        'SeedDMS_Core_Document' => __DIR__ . '/../..' . '/Core/inc.ClassDocument.php',
        'SeedDMS_Core_DocumentCategory' => __DIR__ . '/../..' . '/Core/inc.ClassDocumentCategory.php',
        'SeedDMS_Core_DocumentContent' => __DIR__ . '/../..' . '/Core/inc.ClassDocument.php',
        'SeedDMS_Core_DocumentFile' => __DIR__ . '/../..' . '/Core/inc.ClassDocument.php',
        'SeedDMS_Core_DocumentLink' => __DIR__ . '/../..' . '/Core/inc.ClassDocument.php',
        'SeedDMS_Core_File' => __DIR__ . '/../..' . '/Core/inc.FileUtils.php',
        'SeedDMS_Core_Folder' => __DIR__ . '/../..' . '/Core/inc.ClassFolder.php',
        'SeedDMS_Core_Group' => __DIR__ . '/../..' . '/Core/inc.ClassGroup.php',
        'SeedDMS_Core_GroupAccess' => __DIR__ . '/../..' . '/Core/inc.ClassAccess.php',
        'SeedDMS_Core_KeywordCategory' => __DIR__ . '/../..' . '/Core/inc.ClassKeywords.php',
        'SeedDMS_Core_Notification' => __DIR__ . '/../..' . '/Core/inc.ClassNotification.php',
        'SeedDMS_Core_Object' => __DIR__ . '/../..' . '/Core/inc.ClassObject.php',
        'SeedDMS_Core_Storage' => __DIR__ . '/../..' . '/Core/inc.ClassStorage.php',
        'SeedDMS_Core_Storage_File' => __DIR__ . '/../..' . '/Core/inc.ClassStorageFile.php',
        'SeedDMS_Core_User' => __DIR__ . '/../..' . '/Core/inc.ClassUser.php',
        'SeedDMS_Core_UserAccess' => __DIR__ . '/../..' . '/Core/inc.ClassAccess.php',
        'SeedDMS_Core_Workflow' => __DIR__ . '/../..' . '/Core/inc.ClassWorkflow.php',
        'SeedDMS_Core_Workflow_Action' => __DIR__ . '/../..' . '/Core/inc.ClassWorkflow.php',
        'SeedDMS_Core_Workflow_Log' => __DIR__ . '/../..' . '/Core/inc.ClassWorkflow.php',
        'SeedDMS_Core_Workflow_State' => __DIR__ . '/../..' . '/Core/inc.ClassWorkflow.php',
        'SeedDMS_Core_Workflow_Transition' => __DIR__ . '/../..' . '/Core/inc.ClassWorkflow.php',
        'SeedDMS_Core_Workflow_Transition_Group' => __DIR__ . '/../..' . '/Core/inc.ClassWorkflow.php',
        'SeedDMS_Core_Workflow_Transition_User' => __DIR__ . '/../..' . '/Core/inc.ClassWorkflow.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitfabec6c76cad6aaeaa67db2d20cc093d::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitfabec6c76cad6aaeaa67db2d20cc093d::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInitfabec6c76cad6aaeaa67db2d20cc093d::$classMap;
