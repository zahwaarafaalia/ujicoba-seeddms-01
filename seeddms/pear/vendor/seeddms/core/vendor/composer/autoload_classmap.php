...
return array(
    ...
    'SeedDMS\\Core\\DocumentIterator' => $baseDir . '/Core/inc.ClassIterator.php',
    'SeedDMS\\Core\\FolderFilterIterator' => $baseDir . '/Core/inc.ClassIterator.php',
    'SeedDMS\\Core\\FolderIterator' => $baseDir . '/Core/inc.ClassIterator.php',
    'SeedDMS\\Core\\RecursiveFolderFilterIterator' => $baseDir . '/Core/inc.ClassIterator.php',
    'SeedDMS\\Core\\RecursiveFolderIterator' => $baseDir . '/Core/inc.ClassIterator.php',
    'SeedDMS_Core_AddContentResultSet' => $baseDir . '/Core/inc.ClassDocument.php',
    'SeedDMS_Core_Attribute' => $baseDir . '/Core/inc.ClassAttribute.php',
    'SeedDMS_Core_AttributeDefinition' => $baseDir . '/Core/inc.ClassAttribute.php',
    'SeedDMS_Core_DMS' => $baseDir . '/Core/inc.ClassDMS.php',
    'SeedDMS_Core_DatabaseAccess' => $baseDir . '/Core/inc.DBAccessPDO.php',
    'SeedDMS_Core_Decorator' => $baseDir . '/Core/inc.ClassDecorator.php',
    'SeedDMS_Core_Document' => $baseDir . '/Core/inc.ClassDocument.php',
    'SeedDMS_Core_DocumentCategory' => $baseDir . '/Core/inc.ClassDocumentCategory.php',
    'SeedDMS_Core_DocumentContent' => $baseDir . '/Core/inc.ClassDocument.php',
    'SeedDMS_Core_DocumentFile' => $baseDir . '/Core/inc.ClassDocument.php',
    'SeedDMS_Core_DocumentLink' => $baseDir . '/Core/inc.ClassDocument.php',
    'SeedDMS_Core_File' => $baseDir . '/Core/inc.FileUtils.php',
    'SeedDMS_Core_Folder' => $baseDir . '/Core/inc.ClassFolder.php',
    'SeedDMS_Core_Group' => $baseDir . '/Core/inc.ClassGroup.php',
    'SeedDMS_Core_GroupAccess' => $baseDir . '/Core/inc.ClassAccess.php',
    'SeedDMS_Core_KeywordCategory' => $baseDir . '/Core/inc.ClassKeywords.php',
    'SeedDMS_Core_Notification' => $baseDir . '/Core/inc.ClassNotification.php',
    'SeedDMS_Core_Object' => $baseDir . '/Core/inc.ClassObject.php',
    'SeedDMS_Core_Storage' => $baseDir . '/Core/inc.ClassStorage.php',
    'SeedDMS_Core_Storage_File' => $baseDir . '/Core/inc.ClassStorageFile.php',
    'SeedDMS_Core_User' => $baseDir . '/Core/inc.ClassUser.php',
    'SeedDMS_Core_UserAccess' => $baseDir . '/Core/inc.ClassAccess.php',
    'SeedDMS_Core_Workflow' => $baseDir . '/Core/inc.ClassWorkflow.php',
    'SeedDMS_Core_Workflow_Action' => $baseDir . '/Core/inc.ClassWorkflow.php',
    'SeedDMS_Core_Workflow_Log' => $baseDir . '/Core/inc.ClassWorkflow.php',
    'SeedDMS_Core_Workflow_State' => $baseDir . '/Core/inc.ClassWorkflow.php',
    'SeedDMS_Core_Workflow_Transition' => $baseDir . '/Core/inc.ClassWorkflow.php',
    'SeedDMS_Core_Workflow_Transition_Group' => $baseDir . '/Core/inc.ClassWorkflow.php',
    'SeedDMS_Core_Workflow_Transition_User' => $baseDir . '/Core/inc.ClassWorkflow.php',
